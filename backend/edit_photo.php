...
<?php
$photo=find('photo',$_GET['id']);


?>
<div class="col-md-3 m-auto">
    <img src="../image/<?=$photo['name'];?>" style='width:250px;border:3px solid black'>
<form action="../api/edit_photo.php" method="post" enctype="multipart/form-data">

    <div class='custom-file mx-auto d-block mb-2'>
        <label for="upload" class='custom-file-label'><?=$photo['name'];?></label>
    ...
    <div class="mx-auto text-center mt-2 input-group mb-2">
        ...
        <input class='form-control' type="text" name="intro" id="intro" value="<?=$photo['intro'];?>">
    </div>
